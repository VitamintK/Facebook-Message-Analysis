		...
		for msg in s.children:
			try: 
				if msg.name == "p":
					...
					msg_dict["time"] = pd.to_datetime(halal[1].text)
...
if __name__ == "__main__":
	#import timeit
	#y = timeit.timeit('h = test2()', 'from __main__ import test2', number=1) #727 seconds,	460 seconds 
	#x = timeit.timeit('g = test1()', 'from __main__ import test1', number=1) #1119 seconds,598 seconds
